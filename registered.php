	...
	<div class="container">
		...
		<div class="login-form-grids">
			...
			<form action="" method="post" enctype="multipart/form-data" onsubmit="return validate()">
				...
				<input type="text" id="username" class="form-control" placeholder="Enter Your Username" autocomplete="off" name="username">
				...
				<input type="text" id="mobileno" class="form-control" placeholder="Enter Your Contact" maxlength="10" autocomplete="off" name="user_phone_number">
				<b><small><span id="phone" class="text-danger "></span></small></b>
				<br>

				<!-- Address Declaration -->
				<textarea class="form-control bg-light" id="adrress_feild" name="user_address" placeholder="Enter Your Address" rows="4"></textarea>
				...
				<input type="password" id="confirm_user_password" class="form-control" placeholder="Enter Your Confirm Password" autocomplete="off" name="confirm_user_password">
				<b><small><span id="conf_pass" class="text-danger "></span><br></small></b>

				<!-- Image Declaration -->
				<input type="file" id="user_image" class="form-control" name="user_images" require="required">
