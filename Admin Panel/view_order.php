...
<!-- Navbar Start -->
    ...
    <br>
       ...
       <h2 class="text-center text-dark mb-3">View All Orders</h2>
       <hr>
</nav>
<div class="container-fluid p-0">
    <div class="row">
...
<table class="table table-bordered mt-3">
    <thead class="bg-dark text-white">
      ...
      $select_order_query="select * from user_order_tbl";
      $result_query=mysqli_query($con,$select_order_query);
      $count_query=mysqli_num_rows($result_query);
     if($count_query==0)
     {
        echo "<h3 class='text-center text-danger mt-5'>Not Yet Orders</h3>";
     }
     else
     {
      echo "<tr>
...
<tbody class='bg-light'>";
        ...
        while($row_data=mysqli_fetch_assoc($result_query))
        {
          ...
          $amount_due=$row_data['particular_price'];
          $invoice_number=$row_data['invoice_number'];
          $products_quantity=$row_data['products_quantity'];
          $order_date=$row_data['order_date'];
          $order_status=$row_data['order_status'];
          $number++;
         $select_product_query="select * from product_tbl where product_id=$product_id";
         ...
         while($row_product=mysqli_fetch_array($result_product_query))
         {
          ...
          <th class='text-center'>$amount_due</th>
          <th class='text-center'>$invoice_number</th>
          <th class='text-center'><img src='./Product_Image/$product_image' alt='' class='product'></th>
          <th class='text-center'>$product_current_price X $products_quantity</th>
          <th class='text-center'>$order_date</th>
          <th class='text-center'>$order_status</th>
          <th class='text-center'><a href='delete_order.php?delete_order_id=$order_id'
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">
          <a href='delete_order.php?delete_order_id=<?php echo $order_id?>' 
