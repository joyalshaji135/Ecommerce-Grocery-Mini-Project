...
<!-- Navbar Start -->
    ...
    <br>
       ...
       <h2 class="text-center text-dark mb-3">View Categorys</h2>
</nav>
...
<tbody class="bg-light">
    ...
    <?php
      ...
      $select_category="select * from category_tbl";
      $result_category=mysqli_query($con,$select_category);
      $number=0;
      while($row_cate=mysqli_fetch_assoc($result_category))
      {
     ...
     ?><tr>
        ...
        <th class='text-center'><?php echo $category_name ?></th>
        <th class='text-center'><a href='edit_category.php?category_id=<?php echo $category_id ?>' class='text-dark'><i class='fa-solid fa-pen-to-square'></i></a></th>

        <th class='text-center'><a href='delete_category.php?delete_category=<?php echo $category_id ?>' 
         type="button" class="btn btn-primary text-white" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></th>
        </tr>
         <?php
          }
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"><a href='delete_category.php?delete_category=<?php echo $category_id ?>' 
