		...
		<div class="container">
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<br>
					<a href="joyalshaji755@gmail.com">
						<li><i class="fa-solid fa-envelope"></i>Order online or email us : joyalshaji755@gmail.com</li>
					</a>
				</ul>
			</div>
			...
			<div class="w3l_search">
				<form class="d-flex" action="./search_page.php" method="get">
					<input class="form-control" type="search" placeholder="Search for Products" aria-label="Search" name="search_data" required="required">
					<br>
					<input type="submit" value="Search" class="btn btn-outline-light bg-primary" name="search_data_product" style="margin-left: 155px" aria-label="Left Align">
