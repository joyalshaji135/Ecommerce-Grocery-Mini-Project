...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" class="form-control" value="<?php echo $user_phone_number; ?>" name="user_phone_number">
        </div>

        <div class="form-outline mb-4 w-50 m-auto">
            <center><input type="submit" name="update_value" class="btn btn-dark mb-2 px-4 border border-white" value="Save"></center>
        </div>
    </form>
</body>
