    ...
    <div class="row">
        <div class="col-md-2 border-right p-0">
            ...
            <div class="d-flex rounded text-center mb-3 border border-white">
                    <b><h4 class="text-center">𝐏𝐫𝐨𝐟𝐢𝐞 𝐒𝐞𝐭𝐭𝐢𝐧𝐠𝐬</h4></b>
                </div>
            ...
            <a href="profile.php"><input type="submit" name="#" class="btn btn-white mb-2 px-4 border border-white" 
                value="Pending Order"></a>
                </div>
            <div class="d-flex text-center mb-3">
            <a href="profile.php?edit_account"><input type="submit" name="#" class="btn btn-white mb-2 px-4 border border-white" 
                value="Edit My Account"></a>
                </div>
            <div class="d-flex text-center mb-3">
            <a href="profile.php?my_order"><input type="submit" name="#" class="btn btn-white mb-2 px-4 border border-white" 
                value="My Order Details"></a>
                </div>
            <div class="d-flex text-center mb-3">
            <a href="profile.php?delete_account"><input type="submit" name="#" class="btn btn-white mb-2 px-4 border border-white" 
                value="Delete Account"></a>
                </div>
                <div class="d-flex text-center mb-3">
            <a href="logout.php"><input type="submit" name="#" class="btn btn-white mb-2 px-4 border border-white" 
                value="Account Logout"></a>
                </div>
        </div>
</div>
